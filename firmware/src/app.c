...
void APP_Initialize ( void )
{
    ...
    appData.bufferReady = false;
       
    _audioCodecDataInitialize (&appData.codecData);
    
    appData.delayEnabled = false; //true;  
    ...
    {       
        ...
        {                        
            ...
            if(appData.codecData.writeBufHandle != DRV_CODEC_BUFFER_HANDLE_INVALID)
            {
                ...
                appData.bufferReady = true; // Signal to main() that buffer is ready for processing
            }
        }
        break;
        ...
        {
            // Signal to main() that audio is still buffering
            appData.bufferReady = false;
        }
        break;
