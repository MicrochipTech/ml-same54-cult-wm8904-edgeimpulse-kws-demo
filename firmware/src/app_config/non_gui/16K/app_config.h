...
/* !NB! This must be updated manually to match the Edge Impulse SLICE length */
#define MAX_AUDIO_NUM_SAMPLES     4000

#define MAX_BUFFERS               2     // first two buffers used for ping-pong
                                        // buffers; > 2 buffers used for delay
                                        // !NB! Disabled delay mode for keyword spot demo
